...
export default function EIN({ foundationData, saveFoundationData }) {
  ...
  useEffect(() => {
    if (foundationData) {
      setFormData({
        ein_number: foundationData.ein_number || '',
      });
      setIsEditing(!foundationData.ein_number);
    }
  }, [foundationData]);
  ...
  return (
    <div className="p-6 relative">
      ...
      <h3 className="text-2xl font-bold mb-4">EIN Registration</h3>
