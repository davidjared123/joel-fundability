...
export default function BankName({ sectionData, saveData }) {
  ...
  useEffect(() => {
    if (sectionData) {
      setFormData({
        bank_name: sectionData.bank_name || '',
      });
      setIsEditing(!sectionData.bank_name);
    }
  }, [sectionData]);
  ...
  return (
    <div className="p-6 relative">
      ...
      <h3 className="text-2xl font-bold mb-4">Bank Name</h3>
